...
public class MoleculeDatabaseClusterizationJobTest extends UnitTest{
	...
	AbstractRScriptsLauncher launcher;
	FileUtils fileUtils;
	...
	public void setup() {
		...
		launcher = new MoleculeDatabaseClusterizationJob(database.id);
	...
	public void launcherParallelizeRscript(){
		...
		expect(rscriptLauncher.launchRScript(TemplatedConfiguration.get("clusterize"))).andReturn("nothing");
