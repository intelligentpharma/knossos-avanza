...
public class EcfpComparisonEngineTest extends UnitTest{
	...
	public void retrievesMoleculeDatabasesAndStoresOutputFile(){
		...
		EcfpComparisonEngine engine = new EcfpComparisonEngine();
		...
		Encoding2DECFP encodingMolprint = createMock(Encoding2DECFP.class);
