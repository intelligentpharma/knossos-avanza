...
public class EcfpVariantComparisonEngineTest extends UnitTest{
	...
	public void retrievesMoleculeDatabasesAndStoresOutputFile(){
		...
		EcfpVariantComparisonEngine engine = new EcfpVariantComparisonEngine();
		...
		Encoding2DECFPVariant encodingMolprint = createMock(Encoding2DECFPVariant.class);
